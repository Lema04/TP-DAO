...
const PERMISSIONS = {
  supervisor: ['RegistroAlquiler', 'GestionMultas', 'Reportes', 'GestionClientes', 'RegistrarVehiculo'],
  atencion: ['RegistroAlquiler', 'GestionMultas', 'GestionClientes', 'RegistrarVehiculo'],
